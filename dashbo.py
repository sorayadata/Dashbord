...
url_api = "http://13.38.249.157:5000"      # online API
...
def main():
    ...
    st.markdown(f"Cette application web permet à l'utilisateur de savoir quelle est la probabilité qu'un demandeur de crédit entre en situation de non-paiement des prêts, elle affiche certaines informations sur les clients et compare le demandeur à tous les demandeurs sur certains critères.", unsafe_allow_html=True)
