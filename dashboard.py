...
def main():
    ...
    st.markdown(f"Cette application web permet à l'utilisateur de savoir quelle est la probabilité qu'un demandeur de crédit donné entre en défaut de paiement, elle affiche certaines informations sur les clients et elle compare le demandeur à tous les autre.", unsafe_allow_html=True)
    # Logo
    logo = load_logo()
